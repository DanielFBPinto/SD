...
@REM CURRENT_IDE=%NETBEANS%

@REM ==== JAVA NAMING STUFF ====
@Set JAVAPROJ_NAME=Projeto
@set JAVAPROJ=%WORKDRIVE%:\AT\ufp\Sistemas_Distribuidos\%JAVAPROJ_NAME%
@Set PACKAGE=
@Set PACKAGE_PREFIX=
...
@Set JAVAPACKAGE=
@Set JAVAPACKAGEROLE=%SCRIPT_ROLE%
@Set JAVAPACKAGEPATH=%SCRIPT_ROLE%
@Set JAVASCRIPTSPATH=runscripts
@REM Set JAVASECURITYPATH=%PACKAGE_PREFIX_FOLDERS%/%PACKAGE%/securitypolicies
@Set JAVASECURITYPATH=securitypolicies
